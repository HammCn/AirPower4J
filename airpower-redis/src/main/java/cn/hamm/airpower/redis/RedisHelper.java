...
import static cn.hamm.airpower.core.exception.ServiceError.REDIS_ERROR;
...
public class RedisHelper {
     ...
     * @return 缓存实体
     */
    public final @Nullable <E extends IEntity<E>> E getEntity(E entity) {
     ...
     * @return 缓存的实体
     */
    public final @Nullable <E extends IEntity<E>> E getEntity(String key, E entity) {
     ...
     * @param entity 实体
     */
    public final <E extends IEntity<E>> void deleteEntity(E entity) {
     ...
     * @param entity 实体
     */
    public final <E extends IEntity<E>> void saveEntity(E entity) {
        saveEntity(entity, redis.getCacheExpireSecond());
    }
     ...
     * @param second 缓存时间(秒)
     */
    public final <E extends IEntity<E>> void saveEntity(E entity, long second) {
    ...
    public final <E extends IEntity<E>> void saveEntity(String key, E entity) {
        saveEntity(key, entity, redis.getCacheExpireSecond());
    }
    ...
    public final void set(String key, Object value) {
        set(key, value, redis.getCacheExpireSecond());
    }
     ...
     * @return key
     */
    private @NotNull <E extends IEntity<E>> String getCacheKey(@NotNull E entity) {
