...
public class PasswordUtil {
    ...
    public @NotNull String encode(@NotNull String password, @NotNull String salt) {
        Error.PARAM_MISSING.whenEmpty(password, MessageConstant.PASSWORD_CAN_NOT_BE_NULL);
        Error.PARAM_MISSING.whenEmpty(salt, MessageConstant.PASSWORD_SALT_CAN_NOT_BE_NULL);
