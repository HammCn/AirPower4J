...
import static cn.hamm.airpower.core.request.ContentType.JSON;
import static cn.hamm.airpower.core.request.HttpMethod.GET;
    ...
    private HttpRequest getHttpRequest() {
        ...
        if (Objects.nonNull(cookies)) {
            ...
            requestBuilder.setHeader(
                    "Cookie", String.join(STRING_SEMICOLON + STRING_BLANK, cookieList)
            );
        }
