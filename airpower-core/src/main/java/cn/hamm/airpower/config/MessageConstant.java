...
public class MessageConstant {
    ...
    public static final String EXCEPTION_WHEN_CREATE_INSTANCE = "创建实例失败";
    ...
    public static final String FAILED_TO_LOAD_DICTIONARY = "获取字典信息失败";
    public static final String BLOCK_SIZE_MUST_BE_GREATER_THAN_ZERO = "分段大小必须大于0";
    public static final String EXCEPTION_WHEN_RSA_CRYPTO = "私钥解密失败";
    ...
    public static final String EXCEPTION_WHEN_FILTER_DATA = "过滤数据失败";
